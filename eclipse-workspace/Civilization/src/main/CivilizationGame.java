...
public class CivilizationGame {
	...
	static ImageIcon forestTileII = new ImageIcon(Tile.class.getResource("src/map/resources/forestTile.png"));
	static ImageIcon grassTileII = new ImageIcon(Tile.class.getResource("src/map/resources/grassTile.png"));
