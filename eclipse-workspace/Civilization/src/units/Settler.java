...
public class Settler extends Unit {
	...
	public void keyPressed(KeyEvent e) {
		...
		if(key == KeyEvent.VK_P && (Tile.get$map()[location.get$location()[0]][location.get$location()[1]-1].getOwner() == null ||
		Tile.get$map()[location.get$location()[0]-1][location.get$location()[1]-1].getOwner() == null ||
		Tile.get$map()[location.get$location()[0]+1][location.get$location()[1]+1].getOwner() == null ||
		Tile.get$map()[location.get$location()[0]+1][location.get$location()[1]-1].getOwner() == null ||
		Tile.get$map()[location.get$location()[0]-1][location.get$location()[1]+1].getOwner() == null ||
