...
public abstract class Tile {
	protected final static int MAP_SIZE = 40;
	protected final static int TEXTURE_SIZE = 50;
	protected final static int GENERATION_ITERATIONS = 20;
	protected final static int GENERATION_SIZE_MULTIPLIER = 5;
	protected final static int SAND_GENERATION_ITERATIONS = 5;
	protected final static int SAND_GENERATION_SIZE_MULTIPLIER = 2;
	protected final static int FOREST_GENERATION_ITERATIONS = 6;
